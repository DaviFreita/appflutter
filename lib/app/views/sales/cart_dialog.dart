...
class CartPage extends StatelessWidget {
          ...
          children: [
            ...
            Row(
              children: [
                ...
                // Preço Unitário (Transformado em botão editável)
                Expanded(
  child: GestureDetector(
    behavior: HitTestBehavior.opaque, // 👈 FORÇA o Flutter a detectar o clique em toda a área
    onTap: () => _showEditPriceDialog(context, saleVm, item),
    child: Padding(
      padding: const EdgeInsets.all(8.0), // Aumenta a área de toque para ficar mais fácil de clicar
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Row(
            ...
            children: [
              ...
              Icon(Icons.edit, size: 12, color: const Color(0xFF0D3F87)), // Ícone em azul para chamar a atenção
            ],
          ),
          ...
          Text(
            ...
            style: TextStyle(
              ...
              fontWeight: FontWeight.bold,
              // Deixa o texto sublinhado ou em itálico se já foi alterado para dar feedback visual
  ...
  // 🔥 NOVO MÉTODO: Caixa de diálogo para alterar o preço do item
